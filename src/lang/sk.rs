...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "Nepodarilo sa pripojiť k zoznamovaciemu serveru"),
        ...
        ("A new update is available.", "Vaša inštalácia je staršia"),
        ...
        ("verify_rustdesk_password_tip", "Overenie hesla HopToDesk"),
        ...
        ("powered_by_me", "Poháňané aplikáciou HopToDesk"),
