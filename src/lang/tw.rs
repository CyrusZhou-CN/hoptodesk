...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Generating ...", "正在產生 ..."),
        ("A new update is available.", "您的安裝版本過舊。"),
        ...
        ("confirm_idd_driver_tip", "安裝虛擬顯示器驅動程式的選項已勾選。請注意，測試證書將被安裝以信任虛擬顯示器驅動。測試證書僅會用於信任 HopToDesk 的驅動程式。"),
        ("RDP Settings", "RDP 設定"),
        ("Sort by", "排序方式"),
        ("New Connection", "新連線"),
        ("Restore", "還原"),
        ...
        ("verify_rustdesk_password_tip", "驗證 HopToDesk 密碼"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "您可能遭遇詐騙！"),
        ("scam_text1", "如果您正在和素不相識的人通話，而對方要求您使用 HopToDesk 啟用服務，請勿繼續操作並立即掛斷電話。"),
        ...
        ("powered_by_me", "由 HopToDesk 提供支援"),
