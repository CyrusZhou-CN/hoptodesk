...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Upgrade Now", "Clique para fazer o Upgrade Now"),
        ...
        ("Generating ...", "Gerando ..."),
        ("A new update is available.", "Sua instalação é de uma versão menor."),
       ...
       ("whitelist_tip", "Somente IPs confiáveis podem me acessar"),
        ...
        ("confirm_idd_driver_tip", "A opção para instalar o driver de exibição virtual está marcada. Observe que um certificado de teste será instalado para confiar no driver de vídeo virtual. Este certificado de teste será usado apenas para confiar nos drivers HopToDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do HopToDesk"),
