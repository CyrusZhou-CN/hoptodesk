...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("comfirm_install_cert_tip", "Это тестовый сертификат HopToDesk, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов HopToDesk."),
        ...
        ("verify_rustdesk_password_tip", "Подтвердить пароль HopToDesk"),
        ...
        ("powered_by_me", "Основано на HopToDesk"),
