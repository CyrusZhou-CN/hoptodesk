...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "ID oluşturma sunucusuna bağlanılamadı"),
        ...
        ("A new update is available.", "Kurulumunuz alt sürümdür."),
        ...
        ("verify_rustdesk_password_tip", "HopToDesk parolasını doğrulayın"),
