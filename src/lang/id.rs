...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "Gagal menghubungkan ke signal server"),
        ...
        ("install_tip", "Untuk kinerja terbaik, selesaikan penginstalan penuh."),
        ...
        ("A new update is available.", "Instalasi Anda adalah versi yang lebih rendah."),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi HopToDesk"),
