...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "ZLai nodrošinātu vislabāko veiktspēju, pabeidziet pilnu instalēšanu."),
        ...
        ("enter_HopToDesk_passwd_tip", "Ievadiet HopToDesk paroli"),
        ...
        ("powered_by_me", "Darbojas ar HopToDesk"),
