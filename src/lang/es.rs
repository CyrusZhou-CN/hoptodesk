...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("confirm_idd_driver_tip", "La opción de instalar el controlador de pantalla virtual está marcada. Hay que tener en cuenta que se instalará un certificado de prueba para confirar en el controlador de pantalla. Este certificado solo se usará para confiar en controladores HopToDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de HopToDesk"),
        ...
        ("powered_by_me", "Con tecnología de HopToDesk"),
