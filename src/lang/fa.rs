...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("confirm_idd_driver_tip", "گزینه نصب درایور نمایش مجازی تیک خورده است. توجه داشته باشید که یک گواهی آزمایشی برای اعتماد به درایور نمایش مجازی نصب خواهد شد. این گواهی آزمایشی فقط برای اعتماد به درایورهای HopToDesk استفاده خواهد شد."),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور HopToDesk را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید HopToDesk اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("powered_by_me", "Powered by HopToDesk"),
