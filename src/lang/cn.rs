...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Generating ...", "正在产生 ..."),
        ("A new update is available.", "你安装的版本比当前运行的低。"),
        ...
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的HopToDesk应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on Boot", "开机自启动"),
        ...
        ("confirm_idd_driver_tip", "安装虚拟显示器驱动的选项已勾选。请注意，测试证书将被安装以信任虚拟显示器驱动。测试证书仅会用于信任HopToDesk的驱动。"),
        ("RDP Settings", "RDP 设置"),
        ("Sort by", "排序方式"),
        ("New Connection", "新连接"),
        ("Restore", "恢复"),
        ...
        ("verify_rustdesk_password_tip", "验证 HopToDesk 密码"),
        ...
        ("powered_by_me", "由 HopToDesk 提供支持"),
