...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("comfirm_install_cert_tip", "Acesta este un certificat de testare HopToDesk și este de încredere. Certificatul va fi utilizat pentru a acorda încredere și instala drivere HopToDesk atunci când este necesar."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola HopToDesk"),
		...
		("Enable 2FA", "Activați 2FA"),
		("Enable Wake On LAN", "Activați Wake On LAN"),
		...
		("Choose Network", "Alegeți Rețea"),
		("ID (Click to Copy)", "ID (click pentru a copia)"),		
		("Password (Click to Copy)", "Parola (Click pentru a copia)"),
		("Unattended Access", "Acces Nesupravegheat"),
    ].iter().cloned().collect();
}
